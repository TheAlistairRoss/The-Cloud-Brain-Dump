...
kql_build_artifacts = (
    ...
    "    | project Txt);\r\n"
    "let guidCastText = toscalar(\r\n"
    "    mapped\r\n"
    "    | where Type =~ \"guid\" or Suffix == \"g\"\r\n"
    "    | extend CastEntry = strcat(Name, \" = toguid(\", Name, \")\")\r\n"
    "    | summarize Txt = strcat_array(make_list(CastEntry), \",\\n    \")\r\n"
    "    | project Txt);\r\n"
    "let renameKql = iif(isempty(renameText), \"source\", strcat(\"source\\n| project-rename\\n    \", renameText));\r\n"
    "let guidCastKql = iif(isempty(guidCastText), \"\", strcat(\"\\n| extend\\n    \", guidCastText));\r\n"
    "let transformKql = strcat(renameKql, guidCastKql, \"\\n| extend TimeGenerated = columnifexists(\\\"TimeGenerated\\\", now())\");\r\n"
